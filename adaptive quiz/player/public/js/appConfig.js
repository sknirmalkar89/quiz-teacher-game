AppConfig = {
	...
	apislug: "/action",
	telemetryEventsConfigFields: ["env", "sid", "uid", "did", "channel", "etags", "pdata", "cdata", "app", "dims", "partner", "tags", "rollup", "contextRollup", "mode", "stageid", "enableTelemetryValidation", "timeDiff"],
	mimetypes: [
